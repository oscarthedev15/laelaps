        ...
        <div className="background">
          ...
          <div className="square">
            <p className="textMain">
              ...
              Zeus, Laelaps is a force to be reckoned with. So beware, for if
              you find yourself on the run from Laelaps, there is no escape from
              its unrelenting pursuit.
            </p>
          </div>
          <br></br>
          <div className="square">
            <p className="textMain">
              ...
              blockchain. Through collecting and simplifying data, Laelaps is
              the dog that thrives and improves as you fine tune your own
              methods with him.
            </p>
          </div>
          <br></br>
